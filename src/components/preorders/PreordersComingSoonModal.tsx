...
interface PreordersComingSoonModalProps {
  isOpen: boolean;
  onClose: () => void;
}

const PreordersComingSoonModal = ({ isOpen, onClose }: PreordersComingSoonModalProps) => {
      ...
      `}>
        ...
        <div className="text-center space-y-6">
          ...
          <div className="flex justify-center">
            <div className="p-6 bg-blue-100 rounded-full animate-bounce">
...
export default PreordersComingSoonModal;
