    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
          <motion.div className="text-center mb-16" initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <motion.div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-100 to-purple-100 px-4 py-2 rounded-full text-sm font-medium text-blue-700 mb-6" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2, duration: 0.5 }}>
            ...
            <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.6 }}>
      ...
      <div className="py-20 bg-gradient-to-r from-slate-100 to-blue-100">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" variants={staggerContainer} initial="initial" animate="animate">
            {[
              ...
              <motion.div key={index} initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: index * 0.1 }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <motion.div className="text-center mb-12" initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        ...
        <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" variants={staggerContainer} initial="initial" animate="animate">
          {modules.map((module, index) => (
            <motion.div key={module.path} initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: index * 0.1 }} whileHover={{ y: -12, scale: 1.02, transition: { duration: 0.2 } }} className="group">
              <Card className="overflow-hidden hover:shadow-2xl transition-all duration-300 h-full border-0 bg-white/80 backdrop-blur-sm">
                <CardHeader className="pb-4">
                  <motion.div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${module.color} flex items-center justify-center mb-4 transition-all duration-300 text-white`} whileHover={{ scale: 1.15, rotate: [0, -5, 5, 0], transition: { duration: 0.3 } }}>
                ...
                <CardContent className="pt-0">
                  <motion.div className="bg-gradient-to-r from-gray-50 to-blue-50 p-4 rounded-lg mb-4 relative overflow-hidden border-2 border-transparent transition-all duration-300" whileHover={{ borderColor: "rgba(59, 130, 246, 0.3)", background: "linear-gradient(135deg, rgba(59, 130, 246, 0.05), rgba(147, 51, 234, 0.05))", scale: 1.02, transition: { duration: 0.2 } }}>
                    {/* Header with LIVE indicator */}
                    <motion.div className="flex items-center justify-between mb-3" whileHover={{ x: 2 }} transition={{ duration: 0.2 }}>
                      <div className="flex items-center gap-2">
                        <motion.div className="w-2 h-2 bg-green-500 rounded-full relative" whileHover={{ scale: [1, 1.4, 1], boxShadow: ["0 0 0 0 rgba(34, 197, 94, 0.7)", "0 0 0 6px rgba(34, 197, 94, 0)", "0 0 0 0 rgba(34, 197, 94, 0)"], transition: { duration: 1, repeat: 2, ease: "easeInOut" } }}>
                          <motion.div className="absolute inset-0 bg-green-400 rounded-full" whileHover={{ opacity: [0.5, 1, 0.5], transition: { duration: 0.8, repeat: 2, ease: "easeInOut" } }} />
                        </motion.div>
                        <motion.span className="text-xs font-bold text-gray-500 tracking-wider" whileHover={{ scale: 1.1, color: "#059669", transition: { duration: 0.1 } }}>
                          LIVE ПРИМЕР
                        </motion.span>
                      </div>
                    ...
                    <motion.div className="space-y-3" whileHover={{ y: -2 }} transition={{ duration: 0.2 }}>
                      <motion.p className="text-sm text-gray-700 font-medium leading-relaxed opacity-80" whileHover={{ opacity: 1, scale: 1.02, transition: { duration: 0.1 } }}>
                        {module.example}
                      </motion.p>
                      
                      {/* Stats with enhanced animation */}
                      <motion.div className="flex items-center justify-between bg-white/70 p-3 rounded-md" whileHover={{ backgroundColor: "rgba(255, 255, 255, 0.9)", scale: 1.02, transition: { duration: 0.2 } }}>
                        <motion.div className="flex items-center gap-2" whileHover={{ x: 2, scale: 1.05, transition: { duration: 0.1 } }}>
                          <motion.div whileHover={{ rotate: 15, scale: 1.3, transition: { duration: 0.2 } }}>
                            <TrendingUp className="h-4 w-4 text-green-500" />
                          </motion.div>
                          <motion.span className="text-xs font-semibold text-green-600" whileHover={{ scale: 1.1, color: "#047857", transition: { duration: 0.1 } }}>
                            {module.stats}
                          </motion.span>
                        </motion.div>
                        ...
                        <motion.div className="text-right" whileHover={{ scale: 1.1 }} transition={{ duration: 0.2 }}>
                          <motion.div className="text-xs font-bold text-blue-600" whileHover={{ opacity: 1, y: -2, transition: { duration: 0.1 } }}>
                            {module.animatedValue}
                          </motion.div>
                          <motion.div className="text-xs text-gray-500" whileHover={{ opacity: 0.8, transition: { duration: 0.1 } }}>
                            {module.animatedText}
                          </motion.div>
                        </motion.div>
                      </motion.div>
                    ...
                    <motion.div className="absolute inset-0 bg-gradient-to-r from-transparent via-blue-200/20 to-transparent -skew-x-12 opacity-0" whileHover={{ x: ["-100%", "200%"], opacity: [0, 0.8, 0], transition: { duration: 0.8, ease: "easeInOut" } }} />

                    {/* Corner accent */}
                    <motion.div className="absolute top-2 right-2" whileHover={{ scale: 1.2, rotate: 10, transition: { duration: 0.2 } }}>
                      <motion.div className="text-xs bg-gradient-to-r from-green-100 to-blue-100 text-green-700 px-2 py-1 rounded-full font-bold border border-green-200/50" whileHover={{ background: "linear-gradient(to right, #a7f3d0, #93c5fd)", transition: { duration: 0.2 } }}>
                        <motion.span whileHover={{ opacity: 1, scale: 1.05, transition: { duration: 0.1 } }}>
                          LIVE
                        </motion.span>
                      </motion.div>
                    </motion.div>
                    ...
                    <motion.div className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-blue-500 to-purple-500 opacity-0" whileHover={{ width: ["0%", "100%"], opacity: [0, 0.7, 0.7], transition: { duration: 0.8, ease: "easeInOut" } }} />
                  </motion.div>
                  ...
                  <Link to={module.path}>
                    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} transition={{ duration: 0.1 }}>
                      <Button className="w-full group-hover:bg-primary/90 transition-all duration-300 relative overflow-hidden">
                        ...
                        <motion.div className="ml-2 relative z-10" whileHover={{ x: 4, transition: { duration: 0.2 } }}>
                          <ArrowRight className="h-4 w-4" />
                        </motion.div>
                        
                        {/* Button hover effect */}
                        <motion.div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-purple-600/20" initial={{ x: "-100%" }} whileHover={{ x: "100%", transition: { duration: 0.5, ease: "easeInOut" } }} />
                      </Button>
                    </motion.div>
                  </Link>
                </CardContent>
          ...
          <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                Kaspi Price помогает принимать решения на основе данных, а не интуиции. 
                С нами вы сможете сосредоточиться на росте и масштабировании бизнеса — 
      ...
      <div className="bg-gradient-to-r from-slate-900 via-blue-900 to-purple-900 py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <motion.div className="grid grid-cols-1 lg:grid-cols-2 gap-8" variants={staggerContainer} initial="initial" animate="animate">
            {/* Demo Plan */}
            <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }}>
            ...
            {/* Pro Plan */}
            <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
          ...
          <motion.div className="text-center mt-12" initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }}>
